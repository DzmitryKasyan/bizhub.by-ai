...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-slate-900">Избранное</h1>
        <p class="text-slate-500 text-sm mt-1">Объявления, которые вы сохранили</p>
    </div>
    @if($listings->total() > 0)
...
@else
    ...
    <div class="bg-white rounded-xl border border-slate-100 py-20 text-center">
        ...
        <h3 class="text-lg font-semibold text-slate-900 mb-2">Пока пусто</h3>
