...
<!-- Page Header -->
<div class="mb-6">
    <h1 class="text-2xl font-bold text-slate-900">Сообщения</h1>
    <p class="text-slate-500 text-sm mt-1">Ваши переписки с покупателями и продавцами</p>
</div>
...
<div class="bg-white rounded-xl border border-slate-100 overflow-hidden">
        ...
        <div class="divide-y divide-gray-50">
            @foreach($conversations as $conversation)
                ...
                <a href="{{ route('messages.show', $conversation) }}"
                   class="flex items-start gap-4 px-6 py-5 hover:bg-slate-50 transition-colors group">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between gap-2 mb-1">
                            <span class="font-semibold text-slate-900 text-sm truncate group-hover:text-primary-600 transition-colors">
                        ...
                        @if($conversation->listing)
                            <p class="text-xs text-primary-600 mb-1 truncate">
                    ...
                    <!-- Arrow -->
                    <div class="flex-shrink-0 text-slate-300 group-hover:text-primary-400 transition-colors self-center">
    ...
    @else
        ...
        <div class="py-20 text-center">
            ...
            <h3 class="text-lg font-semibold text-slate-900 mb-2">Нет сообщений</h3>
