...
<body class="bg-slate-50 text-slate-900 antialiased min-h-screen flex flex-col">
    ...
    <header class="bg-white border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center">
            <a href="{{ url('/') }}" class="flex items-center gap-2">
                ...
                <span class="text-xl font-bold text-primary-600">BizHub<span class="text-slate-900">.by</span></span>
            </a>
        </div>
    </header>
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-20">
        <div class="text-center max-w-md">
            ...
            <div class="relative mb-6">
                <p class="text-9xl font-black text-slate-100 select-none leading-none">404</p>
            ...
            <h1 class="text-2xl font-bold text-slate-900 mb-3">Страница не найдена</h1>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-3">
                ...
                <a href="{{ url('/listings') }}"
                   class="inline-flex items-center justify-center gap-2 border border-slate-200 hover:border-slate-300 text-slate-700 font-medium px-6 py-3 rounded-xl transition-colors hover:bg-slate-50">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <footer class="bg-white border-t border-slate-100 py-6">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <p class="text-sm text-slate-400">© {{ date('Y') }} BizHub.by. Все права защищены.</p>
        </div>
    </footer>
